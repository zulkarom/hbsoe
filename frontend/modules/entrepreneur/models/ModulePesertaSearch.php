...
/**
 * ModulePesertaSearch represents the model behind the search form of `backend\models\ModulePeserta`.
 */
class ModulePesertaSearch extends ModulePeserta
{
    /**
     * {@inheritdoc}
     */
